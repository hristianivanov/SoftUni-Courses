    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CollertorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BookId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUsersBooks", x => new { x.BookId, x.CollertorId });
                    table.ForeignKey(
                        name: "FK_IdentityUsersBooks_AspNetUsers_CollertorId",
                        column: x => x.CollertorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityUsersBooks_CollertorId",
